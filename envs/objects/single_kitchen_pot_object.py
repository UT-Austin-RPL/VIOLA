...
class SingleKitchenPotObject(CompositeObject):
    def __init__(
            self,
            name,
        ...
        #         dic=obj_args,
        #         geom_types="box",
        #         geom_locations=(-handle_width / 2, y, 0.055),
        #         geom_quats=T.convert_quat(T.axisangle2quat(np.array([0, 0, 0])), to="wxyz"),
        #         geom_sizes=np.array([handle_length / 2, handle_length / 2, 0.005]),
        #         geom_names=f"handle_{direction}_2",
        #         geom_rgbas=None,
        #         geom_materials=geom_mat,
        #         geom_frictions=(handle_friction, 0.005, 0.0001),
        #         density=1000)
        ...
        #         geom_quats=T.convert_quat(T.axisangle2quat(np.array([0, 0, 0])), to="wxyz"),
        #         geom_sizes=np.array([handle_length / 2, handle_length / 2, 0.005]),
        #         geom_names=f"handle_{direction}_3",
        #         geom_rgbas=None,
        #         geom_materials=geom_mat,
        #         geom_frictions=(handle_friction, 0.005, 0.0001),
        #         density=1000)
